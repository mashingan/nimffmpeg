...
type
  SwrContext {.importc, header: "<libswresample/resample.h>".} = object
...
{.pragma: enumresample, importc: "enum $1", header: "<libswresample/resample.h>".}

type
  SwrDitherType* {.enumresample.} = enum
...
type
  SwrFilterType* {.enumresample.} = enum
