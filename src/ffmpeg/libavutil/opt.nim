...
##
##  @code
##  test_struct *allocest_struct(void)
##  {
...
##      return ret;
##  }
##  void freeest_struct(test_struct **foo)
##  {
##      av_opt_free(*foo);
##      av_freep(foo);
##  }
...
##  @see av_opt_is_seto_default_by_name().
##
...
proc av_opt_is_seto_default*(obj: pointer; o: ptr AVOption): cint
## *
##  Check if given option is set to its default value.
##
##  @param obj          AVClass object to check option on
...
proc av_opt_is_seto_default_by_name*(obj: pointer; name: cstring;
                                      search_flags: cint): cint
const
