...
import pixfmt, pixdesc, rational
...
type ptrdiff {.importc, header: "<stddef.h>".} = object
...
##
##  @note The linesize parameters have the type ptrdiff here, while they are
...
proc av_image_copy_uc_from*(dst_data: array[4, ptr uint8];
                           dst_linesizes: array[4, ptrdiff];
                           src_data: array[4, ptr uint8];
                           src_linesizes: array[4, ptrdiff];
                           pix_fmt: AVPixelFormat; width: cint; height: cint)
## *
...
proc av_image_fill_black*(dst_data: array[4, ptr uint8];
                         dst_linesize: array[4, ptrdiff]; pix_fmt: AVPixelFormat;
